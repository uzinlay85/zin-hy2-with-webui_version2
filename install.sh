...
apt-get update
apt-get install -y curl wget nginx certbot python3 python3-venv python3-pip sqlite3 ufw git btop
...
if [ ! -f /etc/nginx/nginx.conf ]; then
    echo "  ⚠️ Main Nginx config missing, purging and reinstalling Nginx base files..."
